...
3. Optionally assign a Direction field to identify inflow and outflow rows.
4. If Direction is not supplied, positive amounts are treated as inflows and negative amounts are treated as outflows.
...
- Use a Direction column for explicit classification when the data contains both positive and negative accounting conventions.
